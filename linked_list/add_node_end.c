...
printf("before adding the node at end the list is\n");
display();
printf("enter the value to add at end of the list\n");
scanf("%d",&dt);
t= create_node(dt);
insert_end(t);
printf("after adding the node at end the list is\n");
display();
free(t);
return 0;
}
